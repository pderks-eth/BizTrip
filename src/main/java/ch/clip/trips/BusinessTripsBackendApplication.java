	...
	public CommandLineRunner demoData(BusinessTripRepository businessTripRepository, MeetingRepository meetingRepository) {
		...
		return (args) -> {
			...
			BusinessTrip bt03 = new BusinessTrip(3L, "BT03", "San Cose City Halley on Docker/IOT/Client", LocalDateTime.of(2021, 12, 13, 9, 00),  LocalDateTime.of(2021, 12, 15, 16, 56));
                        ...
                        BusinessTrip bt04 = new BusinessTrip(4L, "BT04", "London Tech Summit for Cloud Solutions", LocalDateTime.of(2022, 1, 10, 10, 0), LocalDateTime.of(2022, 1, 13, 18, 30));
                        BusinessTrip bt05 = new BusinessTrip(5L, "BT05", "Munich Security Expo for Networking", LocalDateTime.of(2022, 3, 5, 8, 0), LocalDateTime.of(2022, 3, 7, 17, 45));
                        BusinessTrip bt06 = new BusinessTrip(6L, "BT06", "Zurich Cloud Conference on Migration", LocalDateTime.of(2022, 4, 21, 9, 30), LocalDateTime.of(2022, 4, 25, 19, 0));
                        BusinessTrip bt07 = new BusinessTrip(7L, "BT07", "Paris FinTech Forum customer meetings", LocalDateTime.of(2022, 7, 11, 10, 0), LocalDateTime.of(2022, 7, 15, 16, 0));
                        BusinessTrip bt08 = new BusinessTrip(8L, "BT08", "Berlin DevOps Workshop with partners", LocalDateTime.of(2022, 8, 18, 12, 15), LocalDateTime.of(2022, 8, 22, 15, 0));
                        BusinessTrip bt09 = new BusinessTrip(9L, "BT09", "New York investor roadshow", LocalDateTime.of(2022, 10, 2, 9, 0), LocalDateTime.of(2022, 10, 5, 16, 30));
                        BusinessTrip bt10 = new BusinessTrip(10L, "BT10", "Tokyo hardware vendor negotiations", LocalDateTime.of(2022, 11, 14, 11, 0), LocalDateTime.of(2022, 11, 18, 18, 0));
                        BusinessTrip bt11 = new BusinessTrip(11L, "BT11", "Austin startup accelerator meetings", LocalDateTime.of(2023, 2, 10, 9, 0), LocalDateTime.of(2023, 2, 12, 17, 0));
                        BusinessTrip bt12 = new BusinessTrip(12L, "BT12", "Barcelona IoT showcase", LocalDateTime.of(2023, 5, 3, 8, 30), LocalDateTime.of(2023, 5, 7, 20, 0));
                        BusinessTrip bt13 = new BusinessTrip(13L, "BT13", "Dubai logistics client visits", LocalDateTime.of(2023, 9, 9, 10, 15), LocalDateTime.of(2023, 9, 14, 17, 30));
